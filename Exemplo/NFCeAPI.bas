...
Public Function emitirNFCeSincrono(conteudo As String, tpConteudo As String, tpAmb As String, caminho As String, exibeNaTela As Boolean) As String
    ...
    'Testa se o envio foi feito com sucesso (200) ou se � para reconsultar (-6)
    If (statusEnvio = "100") Or (statusEnvio = "-100") Then
    
        cStat = LerDadosJSON(resposta, "nfeProc", "cStat", "")

        'Testa se o cStat � igual a 100 ou 150, pois ambos significam "Autorizado"
...
'Esta fun��o realiza o envio de uma NFC-e
...
'Esta fun��o realiza o download de documentos de uma NFC-e
...
Public Function downloadNFCeESalvar(chNFe As String, tpAmb As String, caminho As String, exibeNaTela As Boolean) As String
    ...
    Else
        ...
        gravaLinhaLog ("[Ocorreu um erro, veja o Retorno da API para mais informa��es  - Metodo: downloadNFCeESalvar]")
    End If
...
'Esta fun��o realiza a inutiliza��o de um intervalo de numera��o de NFC-e
...
'Esta fun��o realiza o envio de e-mail de uma NFC-e
